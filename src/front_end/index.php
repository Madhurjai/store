        ...
        <?php 
               ...
               include('./classes/products_table.php');
                ...
                foreach( new RecursiveArrayIterator($arr->fetchAll()) as $k=>$v){
                       $html .= ' <div class="col">
                       <div class="card shadow-sm">
                         <svg class="bd-placeholder-img card-img-top" width="100%" height="225" src="image_upload/'.$v['image'].'" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
                         <div class="card-body">
                <h5>'.$v['name'].'</h5>
              <p class="card-text">Sample text below</p>
              <div class="d-flex justify-content-between align-items-center">
                <p><strong>$150</strong>&nbsp;<del><small class="link-danger">'.$v['price'].'</small></del></p>
